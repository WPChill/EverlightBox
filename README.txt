...
4. Select the plugin zip file (everlightbox.zip) from your computer then click the Install Now button.
...
2. Copy the plugin zip file (everlightbox.zip) up to your server and unzip it somewhere on the file system.
...
2. Commenting a photo on a mobile phone
3. Commenting a photo on a desktop
4. Sharing an image on Pinterest
5. Image with caption
6. Sharing an image on Facebook
